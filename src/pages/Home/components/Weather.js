...
const Weather = ({ currentLocation }) => {
    ...
    const fetchForecastData = ( location ) => {
        return axios.get('https://opendata.cwa.gov.tw/api/v1/rest/datastore/F-C0032-001?Authorization=CWB-4943FB9A-E577-4813-9810-8A191171D89A&locationName=' + location + '市')
            .then(res => {
                //console.log(res)
    ...
    const fetchWeatherData = ( location ) => {
        return axios.get(`https://opendata.cwa.gov.tw/api/v1/rest/datastore/O-A0003-001?Authorization=CWB-4943FB9A-E577-4813-9810-8A191171D89A&StationName=`+location)
            .then(res => {
                const locationData = res.data.records.Station[0];
        ...
        <div>
            ...
            <div className="info">
                <p style={{margin:'0 0'}}>
                    ...
                    <span>{data.windSpeed} m/sec   |   </span>
